...
int main(void)
{
  ...
  /* creation of UI_Task */
  UI_TaskHandle = osThreadNew(StartTask02, NULL, &UI_Task_attributes);

  /* creation of CAN_Task */
  CAN_TaskHandle = osThreadNew(StartTask03, NULL, &CAN_Task_attributes);

  /* creation of SD_Task */
  SD_TaskHandle = osThreadNew(StartTask04, NULL, &SD_Task_attributes);
